...
export const sampleDatasets: Record<string, SampleDataset> = {
  ...
  ecommerce: {
    ...
    questions: [
      {
        question: 'سه شهر برتر با بیشترین تعداد سفارش کدامند؟',
        label: 'Ranking',
      },
      {
        question:
          'میانگین امتیاز نظرات ارسالی برای سفارش‌های ثبت شده توسط مشتریان در هر شهر چقدر است؟',
        label: 'Aggregation',
      },
      {
        question:
          'ارزش کل پرداخت‌های انجام شده توسط مشتریان از هر ایالت چقدر است؟',
        label: 'Aggregation',
      },
    ],
    relations: [
