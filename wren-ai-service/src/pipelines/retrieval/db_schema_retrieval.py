...
table_columns_selection_system_prompt = load_template(
    "retrieval/db_schema_retrieval/system.txt"
)

table_columns_selection_user_prompt_template = load_template(
    "retrieval/db_schema_retrieval/user.txt"
)
